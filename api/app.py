...
presence_classifier = load('test/presence_classifier.joblib')
presence_vect = load('test/presence_vectorizer.joblib')
category_classifier = load('test/category_classifier.joblib')
category_vect = load('test/category_vectorizer.joblib')
